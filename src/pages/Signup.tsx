...
export default function Signup() {
  ...
  return (
    <div className="min-h-screen bg-background flex">
      ...
      <div className="hidden lg:flex flex-1 items-center justify-center bg-gradient-to-bl from-primary/20 via-background to-background p-12">
        <div className="text-center space-y-6 max-w-lg">
          ...
          <h2 className="text-4xl font-bold text-foreground">Join TalentTribe</h2>
          <p className="text-xl text-muted-foreground">
            Start your journey to becoming a skilled developer. Track progress, earn badges, and compete with peers.
          </p>
